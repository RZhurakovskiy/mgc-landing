export function animateInteriorExterior() {
  const section = document.getElementById("interior-exterior");
  const image = section.querySelector(".interior-exterior-img");
  const title = section.querySelector(".interior-exterior-title");
  const items = section.querySelectorAll(".interior-exterior-item");
