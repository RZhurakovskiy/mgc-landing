export function initDistrictInteractions() { 
    ...
    document.querySelector(".rf-map").addEventListener("click", function (t) { 
      ...
      if (e) { 
        ...
        if (document.getElementById(l) && "" !== document.getElementById(l).textContent) { 
          ...
          (r.style.display = "block"), 
            ...
            document.querySelectorAll("[data-code]").forEach((t) => t.classList.add("dropfill")), 
    ...
    document.querySelectorAll("[data-code]").forEach(function (t) { 
      ...
      if (document.getElementById(e) && "" !== document.getElementById(e).textContent) { 
    ...
    function closeAllDistricts() {
      ...
      document.querySelectorAll("[data-code].dropfill").forEach((t) => t.classList.remove("dropfill")), 
      document.querySelectorAll("[data-code].mainfill").forEach((t) => t.classList.remove("mainfill")), 
      document.querySelectorAll(".district-text").forEach((t) => (t.style.display = "none")), 
      (document.querySelector(".district").style.display = "none");
    }
  }
